  ...
  container.innerHTML = `
    ...
    <div style="display:flex;align-items:center;gap:10px;padding:10px;border-radius:10px;background:rgba(80,0,80,0.12);border:1px solid #2a0028;margin-bottom:8px;">
      ...
      <div style="flex:1;overflow:hidden;">
        ...
        <div style="font-size:11px;color:#888;margin-bottom:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${lastStory.title.split(' | ')[0]}</div>
        <div style="font-size:13px;font-weight:700;color:#eee;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${lastStory.ytTitle || lastStory.title.split(' | ')[1] || lastStory.title}</div>
